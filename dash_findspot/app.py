            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.H2("FIND STUDY PLACE"),
                        html.P(
                            """Some study spaces are more full than others, but which one is more full? Good question! Our app can show and predict how busy the McGill Libraries and Concordia Libraries is. and make recommendations based on real time population density and predicted population density for those locations. So people can better use the spaces. 
"""
                        ),
                        html.Div(
...
def update_total_rides(datePicked):
    ...
    return "Historic Maximum: {:,d}".format(
...
def update_total_rides_selection(datePicked, selection):
    ...
    if selection is not None or len(selection) is not 0:
        ...
        firstOutput = "Currently: {:,d}".format(totalInSelection)
